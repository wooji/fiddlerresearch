...
const PRODUCTS = { ..._dynamic, ...{
  ...
  'chrome-updates-bball-2526': {
    ...
    retailNote:  'TBD — pre-order stage, no price assigned yet. Rerun at drop.',
    ...
    sellThrough: { flip: { range: 'TBD', units: 'TBD' }, hold: { range: 'TBD', units: 'TBD' }, invest: { range: 'TBD', units: 'TBD' } },
    bulkBuy:  'TBD',
    risk:     'TBD',
    ebayFee:  0.13,
    writeup: {
