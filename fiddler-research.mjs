...
let pcDbPrice = null;
try {
  const DB_BY_CAT = { pokemon:'set-history.json', mtg:'set-history-mtg.json', lorcana:'set-history-lorcana.json', sports:'set-history-sports.json', topps:'set-history-sports.json', other_tcg:'set-history-other-tcg.json', one_piece:'set-history-one-piece.json', 'one-piece':'set-history-one-piece.json', lego:'set-history-lego.json', noncard:'set-history-noncard.json' };
...
const pipelineResult = {
  ...
  dbAppend: (() => {
    const DB_BY_CAT2 = { pokemon:'set-history.json', mtg:'set-history-mtg.json', lorcana:'set-history-lorcana.json', sports:'set-history-sports.json', topps:'set-history-sports.json', other_tcg:'set-history-other-tcg.json', one_piece:'set-history-one-piece.json', lego:'set-history-lego.json', noncard:'set-history-noncard.json' };
