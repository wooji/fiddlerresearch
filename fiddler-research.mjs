...
const PRODUCTS = { ..._dynamic, ...{
  'wallhack-ascension-sora': {
    ...
    category:    'noncard',
    set:         'Wallhack / Sora Line (5th release)',
    retail:      129.00,
    ...
    evidence: [
      ...
      { source: 'eBay active listings, per-generation (scraped 2026-07-02, ebaySold() returned null all gens — zero completed-sold comps exist for this niche, active ask is the only signal)', date: '2026-07-02', point: 'Original Sora (1,000u): 4 listings, median ask $300.61, range $31.30-645.59. Frenzy Sora (2,000u): 25 listings, median ask $575.00, range $16.99-1,045. Drift Sora (5,000u): 18 listings, median ask $325.62, range $109.99-599.19. Carnage Sora (1,800u): 23 listings, median ask $480.27, range $210-620.41. Broad "Wallhack Sora" (all gens): 50 listings, median $313.50, range $79.99-925.' },
      { source: 'wallhack.com/pages/museum (verified)', date: '2026-07-02', point: 'Sora line run sizes: Original Sora 1,000 units (Jan 2023), Frenzy Sora 2,000 (May 2024), Drift Sora 5,000 (Feb 2025), Carnage Sora 1,800 (Mar 2026). Ascension Sora run size not yet disclosed.' },
    ],
    scenarios: [
      { label: 'Bear', prob: 25, text: 'Niche brand, thin collector base outside core audience. Settles near $180-220 (just above retail) — tracks Drift Sora\'s 5,000-unit run, the largest and lowest-median gen ($325).' },
      { label: 'Base', prob: 50, text: 'Finale premium + SOLANI art draws demand in line with the 4-gen active-ask median ($300-480 range). Settles $300-450, tracking Carnage Sora\'s current $480 median ask most closely (same $129 retail, most recent comp).' },
      { label: 'Bull', prob: 25, text: 'Peak Ascension early-access event drives cross-promotion; run size lands tighter than Drift (5,000u). Pushes toward Frenzy Sora\'s $575 median — the highest of any gen despite a 2,000u run, showing run size alone doesn\'t cap price.' },
    ],
    writeup: {
      market:      '• **Thesis — speculative single-drop collectible, not a fundamentals play.** Ascension Sora is the 5th pad in Wallhack\'s Sora line (Original 2023 → Frenzy 2024 → Drift 2025 → Carnage Mar 2026 → Ascension Aug 2026), art by SOLANI. Retail $129, single drop, explicit no-restock policy (wallhack.com FAQ). No completed-SOLD comps exist anywhere in this line (eBay LH_Sold scrape returns null for all 4 prior gens + broad query) — every prior-gen number below is ACTIVE ASK, not confirmed transaction price. Demand precedent by generation: Original $300.61 median (4 listings, 1,000u run), Frenzy $575.00 median (25 listings, 2,000u run — highest of any gen), Drift $325.62 median (18 listings, 5,000u run — largest run, lowest median), Carnage $480.27 median (23 listings, 1,800u run, same $129 retail as Ascension). Run size and ask median do NOT correlate cleanly (Frenzy 2,000u outprices Original 1,000u) — collector sentiment/art reception drives price more than scarcity alone.\n• **Liquidity:** Niche gaming-peripheral collectible, not a mainstream card/toy category — active-listing volume is real (18-25 per gen) but zero sold-through confirmation. Broader "Sora mousepad" query (all gens) shows $79.99-925 range, 50 listings — wide dispersion typical of ask-only thin markets.\n• **Risk:** High — no sold data to confirm any of these asks clear at listed price. Run-size/price relationship is inconsistent across the line (see above), so Ascension\'s undisclosed run size doesn\'t predictably bound its price. Finale narrative could pull buyers who already own Carnage, capping incremental demand.',
      product:     '• **Model:** SP-005 — Wallhack\'s flagship glass pad, 2.5mm tempered glass, CNC-tapered edges, concave silicone base grid, universal sensor compatibility\n• **Art:** SOLANI — 5th illustration in the Sora character arc\n• **Access:** Early access reserved for Peak Ascension climbing-event participants (Jun 30–Jul 6 2026) before general 8.07.2026 drop\n• **Scarcity mechanic:** Explicit single-drop, no-restock — same policy as all 4 prior Sora entries (Original 1,000u, Frenzy 2,000u, Drift 5,000u, Carnage 1,800u)',
      priceComp:   '• Original Sora (Jan 2023, 1,000u): eBay active median $300.61, range $31.30-645.59 (4 listings)\n• Frenzy Sora (May 2024, 2,000u): eBay active median $575.00, range $16.99-1,045 (25 listings) — highest median of any gen\n• Drift Sora (Feb 2025, 5,000u): eBay active median $325.62, range $109.99-599.19 (18 listings) — largest run, lowest-priced of the last 3 gens\n• Carnage Sora (Mar 2026, same $129 retail, 1,800u): eBay active median $480.27, range $210-620.41 (23 listings) — closest comp (retail + recency)\n• Sora line broad comp (all gens): median $313.50, range $79.99-925 (50 listings)\n• All figures = ACTIVE ASK, not sold — zero completed-sold comps exist for this line\n• Base SP-005 (non-LE, always in stock): $129 retail — LE premium is the entire spread above this floor',
      supplyDemand:'• **Supply:** Fixed single drop, run size undisclosed for Ascension. Prior 4 gens ranged 1,000-5,000u with no clean run-size-to-price relationship (Frenzy 2,000u > Original 1,000u in ask). No restock mechanism ever, per brand policy.\n• **Demand:** Line-completion collectors + SOLANI art fans + Wallhack peripheral enthusiasts. All 4 prior gens carry active asks 2.3x-4.5x retail, but with zero sold confirmation the real clearing price is unverified.',
      recs:        '• **At retail ($129):** Buy for flip — 4-gen active-ask floor ($300+) supports a flip thesis even haircut for zero sold confirmation.\n• **Secondary, pre-sellout:** Avoid overpaying above $200 until Ascension\'s actual run size is confirmed — Drift Sora\'s 5,000-unit run produced the softest of the last 3 gens ($325 median) despite genuine demand.\n• **Hold thesis:** Speculative only — no sold comps exist anywhere in this line to confirm asks clear. Treat as high-risk/high-upside, size small.',
    },
  },
  'pitch-black-pc-etb': {
    ...
    tcgId:       692949,
    ebayQuery:   'Pitch Black Pokemon Center Elite Trainer Box',
  ...
  'pitch-black-etb': {
    ...
    tcgId:       692947,
    ebayQuery:   'Pitch Black Elite Trainer Box',
  ...
  '30th-etb': {
    ...
    tcgId:       null,
    ebayQuery:   '30th Celebration Elite Trainer Box',
  ...
  'ah-etb': {
    ...
    rating:     'DBLGREEN',
    tcgId:      668496,
    ebayQuery:  'Ascended Heroes Elite Trainer Box',
  ...
  'ah-bb': {
    ...
    rating:     'GREEN',
    tcgId:      668500,
    ebayQuery:  'Ascended Heroes Booster Bundle',
    images:    [668500],
  ...
  'pe-etb': {
    ...
    rating:     'DBLGREEN',
    tcgId:      593355,
    ebayQuery:  'Prismatic Evolutions Elite Trainer Box',
    images:    [593355],
  ...
  'cr-bb': {
    ...
    rating:       'ORANGE',
    tcgId:        684456,
    ebayQuery:    'Chaos Rising Booster Bundle',
    images:    [684456],
  ...
  'pb-bb': {
    ...
    rating:     'GREEN',
    tcgId:      692942,
    ebayQuery:  'Pitch Black Booster Bundle',
    images:    [],
  ...
  'chrome-updates-bball-2526': {
    label:       '2025-26 Topps Chrome Updates Basketball Hobby Box',
    category:    'topps',
    set:         'Topps Chrome Updates Basketball',
    retail:      700,
    retailVerified: true,
    retailNote:  'MSRP $700 verified via StockX productAttributes.retailPrice · July 7 2026 release',
    forceRating: 'ORANGE',
    forceRisk:   '🟡 Medium',
    releaseUrl:  'https://www.topps.com/pages/topps-chrome-updates-basketball',
    tcgId:       null,
    preRelease:  true,
    supplyScore: 30,
    ...
    evidence: [
      { source: 'topps.com/pages/topps-chrome-updates-basketball', date: '2026-07-01', point: 'Pre-order live July 7 2026. Rookie Debut Patch Autos (1/1) debut in basketball — Cooper Flagg, Kon Knueppel, Dylan Harper. 200-card base set with in-season photography.' },
      { source: 'topps.com product page', date: '2026-07-01', point: 'Box config confirmed: Hobby 20pk×4c, 1 auto. Jumbo 12pk×11c, 3+ autos. Breakers Delight 1pk×10c, 2+ autos including geometric auto.' },
      { source: 'topps.com product page', date: '2026-07-01', point: 'Key SSPs: Alter Egos (10-card set), Minions NBA (Illumination collab), Denim Tears parallel. Autos: Chrome Autos, 1980-81 Topps Bball Autos, Lava Lamp Rookie Autos, Druski + Spike Lee appearances.' },
    ],
    sellThrough: {
      flip:   { range: '$900 – $1,100', units: '~10 – 25 boxes' },
      hold:   { range: '$1,000 – $1,250', units: '~5 – 15 boxes' },
      invest: { range: '$1,100 – $1,400', units: '~3 – 8 boxes' },
    },
    bulkBuy:  '~10 – 25 boxes',
    risk:     '🟡 Medium',
    ebayFee:  0.13,
    writeup: {
      market:       'TBD — pre-order, no secondary market yet. Cooper Flagg Rookie Debut Patch Auto (1/1) will be the primary ceiling driver. Comp: 2025-26 Topps Chrome Basketball Hobby at $883 secondary.',
      product:      '2025-26 Topps Chrome Updates Basketball is the mid-season update release headlined by Rookie Debut Patch Autos — 1/1 game-worn NBA Debut patches, making their basketball debut. Cooper Flagg leads the rookie checklist. 200-card base with refreshed in-season imagery. Hobby Jumbo is the premium format at 3+ autos per box.',
      priceComp:    'TBD — no retail price assigned at pre-order stage. 2025-26 Topps Chrome Basketball Hobby (base set) at $883 secondary / ~$650 retail. Chrome Updates historically prices below flagship.',
      supplyDemand: 'Cooper Flagg as the centerpiece rookie creates real demand. Alter Egos SSP + Minions NBA collab add collector crossover. Supply unknown until allocation announced. Chrome Updates typically lower print run than flagship Chrome.',
      recs:         'TBD at rerun. Hold judgment until retail price confirmed and eBay presale market establishes. Monitor Cooper Flagg 1/1 Debut Patch auction when product drops.',
    },
  },

  'chrome-marvel-2026': {
    label:       '2026 Topps Chrome Marvel Comics Hobby Box',
    category:    'disney_cards',
    set:         'Topps Chrome Marvel',
    retail:      299.99,
    retailVerified: true,
    retailNote:  'MSRP $299.99 release day (presale $289.99 from 6/2/26) · July 1 2026 drop · Verified Topps.com + DA Card World + GameStop + Beckett',
    releaseUrl:  'https://www.topps.com/products/2026-topps-chrome%C2%AE-marvel-comics-hobby-box',
    tcgId:       null,
    supplyScore: 25,
    forceRating: 'GREEN',
    forceRisk:   '🟢 Low-Medium',
    liveMarket:  { market: 490, low: 460, high: 560, sales: 3, note: 'eBay presale ask $479.99 (3 sold) — floor discovery in progress, release day 7/1/26' },
    ebayQuery:   '2026 Topps Chrome Marvel Comics Hobby Box',
    images:      [],
    evidence: [
      { source: 'Topps.com + DA Card World + GameStop + Beckett', date: '2026-07-01', point: 'Retail $299.99 confirmed on release day (presale $289.99 from June 2); hobby box 12pk×6 = 72 cards, 8 boxes/case; Artist Autos: Adi Granov, Frank Miller, Kevin Eastman, Artgerm; 200-card base set; release date July 1 2026' },
      { source: 'eBay search results', date: '2026-07-01', point: 'eBay presale ask $479.99 (3 solds confirmed); 48 active hobby listings; release-day floor discovery in progress; 2025 Chrome Marvel hobby ran to ~$560 on eBay (57+ solds) from same $299.99 retail = 1.87× comp' },
    ...
    ebayFee:  0.13,
    writeup: {
      market:      '• **Thesis:** Marvel IP = largest entertainment card crossover (MCU + comic collectors + Chrome refractor hunters converging on one SKU). 2025 Topps Chrome Marvel hobby ran to ~$560 on eBay (1.87× retail, 57+ units sold from single listing) — direct year-over-year comp confirms the floor. Release-day eBay presale showing $480 ask (3 sold) = early floor discovery, well above retail.\n• **Liquidity:** High — 2025 comp showed deep eBay volume; Chrome format moves fast within 30 days of release. Blue-chip auto roster (Frank Miller, Artgerm, Kevin Eastman, Adi Granov) = grading targets that lift single-card ceiling.\n• **Risk:** Fixed hobby print run (no reprint), but entertainment card demand is narrower wallet vs sports. Price ceiling gated on auto subject quality revealed post-break; Artgerm/Frank Miller autos = A-tier, lesser names compress.',
  ...
  'casio-gshock-pokemon-ga110': {
    label:       'Pokémon × Casio G-Shock GA-110PKM-7A Watch',
    category:    'noncard',
    set:         'Pokémon / Casio G-Shock Collab',
    retail:      270.00,
    retailVerified: true,
    retailNote:  'MSRP $270.00 (verified: casio.com GA-110PKM-7ACR schema, priceValidUntil 2026-07-31)',
    releaseUrl:  'https://www.casio.com/us/watches/gshock/product.GA-110PKM-7A/',
    tcgId:       null,
    preRelease:  true,
    forceRating: 'DBLGREEN',
    supplyScore: 20,
    liveMarket:  null,
    ebayQuery:   'Casio G-Shock Pokemon GA-110PKM watch',
    images:      [],
    contents:    'GA-110PKM-7A | clear/translucent body + strap | Pikachu graphics + official Pokémon logo on face | shock + water resistant (standard GA-110 spec) | first full-sized Pokémon × G-Shock collab (past collabs = Baby-G compact only)',
    releaseDate: 'Pre-order / upcoming — listed on casio.com/us Jun 2026 | No official release date announced | JP model (GA-110PKM-7AJR) already in pre-order secondary $447–$500',
    sellThrough: {
      flip:   { range: '$350 – $500', units: '25 – 75 units' },
      hold:   { range: '$400 – $600', units: '10 – 25 units (6–12mo post-release)' },
      invest: { range: 'SKIP',        units: 'N/A' },
    },
    bulkBuy:  '25 – 75 units at retail — first full-sized Pokemon/G-Shock = collector milestone, strong IP premium',
    risk:     '🟠 Medium — pre-release, US MSRP unconfirmed; JP secondary $450–500 sets floor',
    ebayFee:  0.13,
    writeup: {
      market:      '• **Thesis:** First full-sized Pokémon × G-Shock collab (all prior = Baby-G compact). Collector milestone positioning + Pokémon 30th anniversary IP = premium ceiling well above standard GA-110 comps. JP pre-orders ($447–$500) confirm demand is there before US retail even opens.\n• **Liquidity:** Pre-release thin — JP import flippers dominating. US secondary will open significantly on launch day. eBay active listings already clustered $450–$550 (import).\n• **Risk:** US MSRP unconfirmed; if wide-release at retail $110–130, margin compresses vs a $150–200 collab MSRP. Key risk = allocation (limited collab drop vs open run). Monitor official Casio US / Pokemon Center announcements.',
      product:     '• GA-110PKM-7A (US) / GA-110PKM-7AJR (JP) — clear translucent G-Shock GA-110 XL silhouette\n• Pokémon 30th anniversary branding: Pikachu character graphics + official Pokémon logo face\n• Standard GA-110 specs: shock/water resistant, analog-digital, XL case\n• First FULL-SIZED Pokemon × G-Shock ever — prior collabs were all Baby-G compact; this is the flagship GA-110 body\n• JP pre-order secondary: $447–$500 | US model listed casio.com/us — no MSRP yet',
      priceComp:   '• JP eBay import pre-orders: $447–$500 | eBay active: $548 preorder listing\n• Standard GA-110 retail comps: $110–130 | collab premium estimate: $150–200 US MSRP\n• Prior G-Shock collabs (Bape, Dragon Ball Z, One Piece): 3–5× retail in first 30 days\n• Pokemon IP G-Shock Baby-G prior collab resale: held 2–3× retail 12mo+ post-release\n• At $150–200 retail → target market $450–600 (3–4× = consistent with collab comps)',
      supplyDemand:'• Supply unknown — no official allocation announced; if collab-limited → scarcity premium\n• JP market already building bid wall $430–490 before US even opens\n• Pokémon 30th anniversary demand multiplier — coincides with peak IP engagement (2026)\n• Watches = different buyer pool than TCG (G-Shock collectors + Pokemon collectors overlap = double demand)\n• Risk: if casio.com US does an open/restockable run, supply absorbs fast and kills premium',
      recs:        '• **Pre-release:** Buy import at $450–$500 ONLY if confident collab is limited-run. Wait for US MSRP confirmation before sizing in.\n• **At US retail ($150–200):** Full send — 25–75 units. Exit within 30 days of release at $400–550.\n• **Hold thesis:** 6–12mo if limited collab confirmed; prior Pokemon/G-Shock Baby-G held 2–3× retail for 12mo+\n• **Pass if:** US release is open/restockable run at standard GA-110 pricing ($110–130). Margin math breaks below $130 retail with $350–400 market ceiling.\n• Watch for: official Pokemon Center listing (confirmed limited) vs Casio mass-retail (open run).',
    },
  },
  'mtg-sl-purr-majesty': {
...
ebayQuery:   "Assassin\'s Creed Black Flag Resynced Collector\'s Edition PS5",
  ...
  'dr-etb': {
    ...
    tcgId:      624676,
    ebayQuery:  'Destined Rivals Elite Trainer Box',
    images:    [624676],
  ...
  'po-etb': {
    ...
    rating:     'GREEN',
    tcgId:      672401,
    ebayQuery:  'Perfect Order Elite Trainer Box',
    images:    [672401],
  ...
  'cr-etb': {
    ...
    rating:     'GREEN',
    tcgId:      684450,
    ebayQuery:  'Chaos Rising Elite Trainer Box',
    images:    [684450],
  ...
  'ah-display': {
    ...
    rating:     'DBLGREEN',
    tcgId:      692362,
    ebayQuery:  'Ascended Heroes Booster Display',
    images:    [692362],
