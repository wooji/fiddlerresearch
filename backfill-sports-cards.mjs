...
const PLAYER_SETS = [
  ...
  ...[2017,2018,2019,2020,2021,2022,2023,2024].flatMap(y => [
    ...
    { name: `${y} Topps Update Series Baseball`,      sport: 'baseball', year: y, brand: 'topps',  tier: 'update' },
    { name: `${y} Bowman Chrome Baseball`,            sport: 'baseball', year: y, brand: 'bowman', tier: 'chrome' },
    { name: `${y} Bowman Draft Baseball`,             sport: 'baseball', year: y, brand: 'bowman', tier: 'draft' },
    { name: `${y} Bowman Sterling Baseball`,          sport: 'baseball', year: y, brand: 'bowman', tier: 'sterling' },
    { name: `${y} Topps Tier One Baseball`,           sport: 'baseball', year: y, brand: 'topps',  tier: 'tier-one' },
    { name: `${y} Topps Heritage Baseball`,           sport: 'baseball', year: y, brand: 'topps',  tier: 'heritage' },
    { name: `${y} Topps Stadium Club Baseball`,       sport: 'baseball', year: y, brand: 'topps',  tier: 'stadium-club' },
    { name: `${y} Topps Finest Baseball`,             sport: 'baseball', year: y, brand: 'topps',  tier: 'finest' },
    { name: `${y} Topps Allen and Ginter Baseball`,   sport: 'baseball', year: y, brand: 'topps',  tier: 'allen-ginter' },
    { name: `${y} Topps Gold Label Baseball`,         sport: 'baseball', year: y, brand: 'topps',  tier: 'gold-label' },
    { name: `${y} Topps Five Star Baseball`,          sport: 'baseball', year: y, brand: 'topps',  tier: 'five-star' },
    { name: `${y} Topps Gypsy Queen Baseball`,        sport: 'baseball', year: y, brand: 'topps',  tier: 'gypsy-queen' },
    { name: `${y} Topps Gallery Baseball`,            sport: 'baseball', year: y, brand: 'topps',  tier: 'gallery' },
    { name: `${y} Topps Archives Baseball`,           sport: 'baseball', year: y, brand: 'topps',  tier: 'archives' },
    { name: `${y} Topps Big League Baseball`,         sport: 'baseball', year: y, brand: 'topps',  tier: 'big-league' },
    { name: `${y} Panini National Treasures Baseball`,sport: 'baseball', year: y, brand: 'panini', tier: 'national-treasures' },
    { name: `${y} Panini Immaculate Baseball`,        sport: 'baseball', year: y, brand: 'panini', tier: 'immaculate' },
    { name: `${y} Panini Prizm Baseball`,             sport: 'baseball', year: y, brand: 'panini', tier: 'prizm' },
    { name: `${y} Panini Diamond Kings Baseball`,     sport: 'baseball', year: y, brand: 'panini', tier: 'diamond-kings' },
    { name: `${y} Panini Donruss Baseball`,           sport: 'baseball', year: y, brand: 'panini', tier: 'donruss' },
  ...
  ...[2017,2018,2019,2020,2021,2022,2023,2024].flatMap(y => [
    ...
    { name: `${y} Panini Donruss Optic Basketball`,      sport: 'basketball', year: y, brand: 'panini', tier: 'optic' },
    { name: `${y} Panini Contenders Basketball`,         sport: 'basketball', year: y, brand: 'panini', tier: 'contenders' },
    { name: `${y} Panini Hoops Basketball`,              sport: 'basketball', year: y, brand: 'panini', tier: 'hoops' },
    { name: `${y} Panini Flawless Basketball`,           sport: 'basketball', year: y, brand: 'panini', tier: 'flawless' },
    { name: `${y} Panini Gold Standard Basketball`,      sport: 'basketball', year: y, brand: 'panini', tier: 'gold-standard' },
    { name: `${y} Panini Spectra Basketball`,            sport: 'basketball', year: y, brand: 'panini', tier: 'spectra' },
    { name: `${y} Panini Origins Basketball`,            sport: 'basketball', year: y, brand: 'panini', tier: 'origins' },
    { name: `${y} Panini Status Basketball`,             sport: 'basketball', year: y, brand: 'panini', tier: 'status' },
    { name: `${y} Panini Revolution Basketball`,         sport: 'basketball', year: y, brand: 'panini', tier: 'revolution' },
    { name: `${y} Panini Illusions Basketball`,          sport: 'basketball', year: y, brand: 'panini', tier: 'illusions' },
    { name: `${y} Panini Absolute Basketball`,           sport: 'basketball', year: y, brand: 'panini', tier: 'absolute' },
    { name: `${y} Panini Certified Basketball`,          sport: 'basketball', year: y, brand: 'panini', tier: 'certified' },
    { name: `${y} Panini Phoenix Basketball`,            sport: 'basketball', year: y, brand: 'panini', tier: 'phoenix' },
    { name: `${y} Panini Encased Basketball`,            sport: 'basketball', year: y, brand: 'panini', tier: 'encased' },
    { name: `${y} Panini Playbook Basketball`,           sport: 'basketball', year: y, brand: 'panini', tier: 'playbook' },
    { name: `${y} Panini Cornerstones Basketball`,       sport: 'basketball', year: y, brand: 'panini', tier: 'cornerstones' },
  ...
  ...[2019,2020,2021,2022,2023,2024].flatMap(y => [
    ...
    { name: `${y} Panini Black Basketball`,     sport: 'basketball', year: y, brand: 'panini', tier: 'black' },
  ]),
  ...[2022,2023,2024].map(y => ({ name: `${y} Panini Titanium Basketball`, sport: 'basketball', year: y, brand: 'panini', tier: 'titanium' })),
